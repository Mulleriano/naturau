...
import { petDados, petStore } from "../store";
...
<template>
  ...
  <v-container class="w-100 mt-16 bg-green d-flex flex-column align-center">
    ...
    <v-card elevation="0" width="85%" position="absolute" location="bottom"  class="d-flex mb-2" rounded="lg">
  <v-card elevation="0"  width="80%">
  <h3 class="ma-2">Ivy</h3>
  <p class="text-caption ma-2"> <v-icon icon="mdi-map-marker-outline pb-1"></v-icon> Rua tals lala e la, 123 </p>
  </v-card>
