...
<template>
  <body class="w-100 h-100 d-flex flex-column align-center justify-center">
    ...
    <v-btn @click="login" variant="outlined" size="small" class="mt-2">Logar</v-btn>
    <v-btn @click="signInWithGoogle" variant="outlined" size="small" class="mt-2"
      >Entre com o Google</v-btn
    >
    <p>Não tem cadastro? <router-link class="text-decoration-none"
          to="/register">Registre-se</router-link></p>
  </body>
</template>
